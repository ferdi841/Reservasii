...
<body>
  ...
  <script>
    function startBooking() {
      ...
      const pesan = `Halo HB Barbershop,%0ASaya *${nama}* ingin reservasi pada:%0A📅 Tanggal: ${tanggal}%0A⏰ Jam: ${waktu}%0A%0A⏳ Waktu reservasi berlaku hingga jam *${jamSelesai}*%0A%0AWebsite: [link_anda_di_sini]`;
